...
class MyWin(QtWidgets.QMainWindow):
    ...
    def mixXml(self):
        ...
        self.linesMixed = []
        self.r = open("db3.xml", 'r', encoding='utf-8')
    ...
    def check(self):
        ...
        # make interface locked after clicking 'check' button
        #self.ui.scrollArea.setEnabled(False)
        #self.ui.pushButton.setEnabled(False)

        # make timesSeconds equal to zero and call function to disable UI for modification
