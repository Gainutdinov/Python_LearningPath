...
# Form implementation generated from reading ui file 'C:\Users\Марат\Desktop\Code\week4\imageConverter\widgets\imageConverter.ui'
#
...
class Ui_imageConverter(object):
    ...
    def retranslateUi(self, imageConverter):
        ...
        self.start_btn.setText(_translate("imageConverter", "Strat"))
