...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 394, 381))
        ...
        self.svIntoFile_btn.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.svIntoFile_btn.setObjectName("svIntoFile_btn")
        self.gridLayout.addWidget(self.svIntoFile_btn, 0, 0, 1, 1)
        self.prevQues_btn = QtWidgets.QPushButton(self.centralwidget)
        self.prevQues_btn.setEnabled(True)
        self.prevQues_btn.setObjectName("prevQues_btn")
        self.gridLayout.addWidget(self.prevQues_btn, 0, 2, 1, 1)
        self.clipboard_brn = QtWidgets.QPushButton(self.centralwidget)
        self.clipboard_brn.setObjectName("clipboard_brn")
        self.gridLayout.addWidget(self.clipboard_brn, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.svIntoFile_btn.setText(_translate("MainWindow", "To previous question"))
        self.prevQues_btn.setText(_translate("MainWindow", "To save into file"))
        self.clipboard_brn.setText(_translate("MainWindow", "Copy into clipboard"))
